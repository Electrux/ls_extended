...
int main()
{
	...
	fprintf( OUT_LOC, "Deleting by string\n" );
	int res2 = str_vec_rem_str( strs, "Hello world" );
	fprintf( OUT_LOC, "=> Result = %d, New size = %zu\n", res2, str_vec_get_count( strs ) );

	fprintf( OUT_LOC, "Deleting string which does not exist\n" );
